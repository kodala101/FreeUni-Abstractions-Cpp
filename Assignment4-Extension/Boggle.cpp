...
//This is BIG_BOGGLE. Since I was using constant variables of NUM_ROWS and NUM_COLS in standart BOGGLE, now i've just make them equal to 5 and that works correctly.
...
Grid<char> fillBoard(Vector<string>& playersCubes) {
    ...
    if (playersCubes.isEmpty()) {
        for (string cube : BIG_BOGGLE_CUBES) cubes.add(cube);
    }
    else {
